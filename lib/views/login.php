<div id="content">
    <noscript>
        <div class="has-error">
            <div class="help-block">JavaScript is required to access . Please enable before attempting to login.</div>
        </div>
    </noscript>
    

<!-- Cribbed from http://bootsnipp.com/snippets/featured/login-and-register-tabbed-form -->
<!-- Don't invent, repurpose -->
    <div class="container">
        <div class="row">
